...
class PermissionController extends GetxController {
  ...
  void toggleLocationService() =>
      locationServiceEnabled.value = !locationServiceEnabled.value;
  void toggleAccessCalendar() =>
      accessCalendarEnabled.value = !accessCalendarEnabled.value;
  void toggleAccessContacts() =>
      accessContactsEnabled.value = !accessContactsEnabled.value;
  void toggleAllowNotification() =>
      allowNotificationEnabled.value = !allowNotificationEnabled.value;
